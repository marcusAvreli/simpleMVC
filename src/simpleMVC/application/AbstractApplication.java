...
import simpleMVC.container.DefaultViewContainerFrame;
import simpleMVC.container.ViewContainerFrame;
import simpleMVC.manager.DefaultViewManager;
import simpleMVC.manager.ViewManager;
import simpleMVC.perspective.DefaultPerspective;
...
public abstract class AbstractApplication implements Application
{
	...
	public AbstractApplication(){
		...
		if(null == viewManager) {
			logger.info("viewManager_is_null");
		}else {
			logger.info("viewManager_is_not_null");
		}
	}
