...
import simpleMVC.container.ViewContainer;
import simpleMVC.perspective.PerspectiveConstraint;
...
public abstract class AbstractViewManager implements ViewManager
{
	...
	public Container arrangeViews()
	{
	  ...
	  * it is mandatory to create different view collections. */
		...
		if(null == this.getPerspective()) {
			logger.info("perspective_is_null");
		}else {
			logger.info("perspective_is_not_null");
		}
